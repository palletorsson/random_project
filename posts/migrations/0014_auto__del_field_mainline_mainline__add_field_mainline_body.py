...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Mainline.mainline'
        db.delete_column(u'posts_mainline', 'mainline')

        # Adding field 'Mainline.body'
        db.add_column(u'posts_mainline', 'body',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Mainline.mainline'
        db.add_column(u'posts_mainline', 'mainline',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Mainline.body'
        db.delete_column(u'posts_mainline', 'body')
