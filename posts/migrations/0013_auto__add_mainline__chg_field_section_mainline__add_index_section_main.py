...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'posts_mainline', (
            ...
            ('mainline', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'posts', ['Mainline'])


        # Renaming column for 'Section.mainline' to match new field type.
        db.rename_column(u'posts_section', 'mainline', 'mainline_id')
        # Changing field 'Section.mainline'
        db.alter_column(u'posts_section', 'mainline_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['posts.Mainline'], null=True))
        # Adding index on 'Section', fields ['mainline']
        db.create_index(u'posts_section', ['mainline_id'])


    def backwards(self, orm):
        # Removing index on 'Section', fields ['mainline']
        db.delete_index(u'posts_section', ['mainline_id'])
        ...
        # Renaming column for 'Section.mainline' to match new field type.
        db.rename_column(u'posts_section', 'mainline_id', 'mainline')
        # Changing field 'Section.mainline'
        db.alter_column(u'posts_section', 'mainline', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        u'posts.mainline': {
            'Meta': {'object_name': 'Mainline'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mainline': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'posts.post': {
        ...
        u'posts.section': {
            ...
            'mainline': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['posts.Mainline']", 'null': 'True', 'blank': 'True'}),
