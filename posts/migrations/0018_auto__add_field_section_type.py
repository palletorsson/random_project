...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'posts_section', 'type',
                      self.gf('django.db.models.fields.CharField')(default='default', max_length=12),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Section.type'
        db.delete_column(u'posts_section', 'type')
    ...
    models = {
        ...
        u'posts.post': {
            ...
            'publish_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 30, 0, 0)'}),
