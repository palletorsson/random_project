...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.credits'
        db.add_column(u'posts_post', 'credits',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.credits'
        db.delete_column(u'posts_post', 'credits')
    ...
    models = {
        ...
        u'posts.post': {
            ...
            'publish_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 24, 0, 0)'}),
