...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Paragraf'
        db.delete_table(u'posts_paragraf')

        # Adding model 'Section'
        db.create_table(u'posts_section', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('level', self.gf('django.db.models.fields.CharField')(default='h2', max_length=12, null=True, blank=True)),
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(related_name='paragraf', to=orm['posts.Post'])),
        ))
        db.send_create_signal(u'posts', ['Section'])

        # Adding field 'Post.simple_text'
        db.add_column(u'posts_post', 'simple_text',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'Paragraf'
        db.create_table(u'posts_paragraf', (
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('level', self.gf('django.db.models.fields.CharField')(default='h2', max_length=12, null=True, blank=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(related_name='paragraf', to=orm['posts.Post'])),
        ...
        db.send_create_signal(u'posts', ['Paragraf'])

        # Deleting model 'Section'
        db.delete_table(u'posts_section')

        # Deleting field 'Post.simple_text'
        db.delete_column(u'posts_post', 'simple_text')
