...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'posts_post', (
            ...
            ('publish_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 10, 9, 0, 0))),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('blog', self.gf('django.db.models.fields.related.ForeignKey')(related_name='posts', to=orm['posts.Blog'])),
        ))
    ...
    models = {
        ...
        u'posts.post': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'publish_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 9, 0, 0)'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
