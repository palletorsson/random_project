...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.gen_tags'
        db.add_column(u'posts_post', 'gen_tags',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.gen_tags'
        db.delete_column(u'posts_post', 'gen_tags')
    ...
    models = {
        ...
        u'posts.post': {
            ...
            'gen_tags': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'html_text': ('tinymce.models.HTMLField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('filebrowser.fields.FileBrowseField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'publish_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 30, 0, 0)'}),
