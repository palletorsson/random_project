...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Section.note'
        db.add_column(u'posts_section', 'note',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'posts_section', 'mainline')

        # Deleting field 'Section.note'
        db.delete_column(u'posts_section', 'note')
