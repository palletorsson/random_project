...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'project_project', (
            ...
            ('announce', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('summery', self.gf('django.db.models.fields.TextField')()),
            ...
            ('publish_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 28, 0, 0))),
            ('realtime_started', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('realtime_ended', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('process', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('credits', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'project', ['Project'])

        # Adding M2M table for field posts on 'Project'
        m2m_table_name = db.shorten_name(u'project_project_posts')
        ...
        db.create_unique(m2m_table_name, ['project_id', 'post_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field posts on 'Project'
        db.delete_table(db.shorten_name(u'project_project_posts'))
    ...
    models = {
        ...
        u'project.project': {
            'Meta': {'ordering': "['-publish_at']", 'object_name': 'Project'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'announce': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('filebrowser.fields.FileBrowseField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'posts': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'posts'", 'symmetrical': 'False', 'to': u"orm['posts.Post']"}),
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'summery': ('django.db.models.fields.TextField', [], {}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '40'})
        }
    }
