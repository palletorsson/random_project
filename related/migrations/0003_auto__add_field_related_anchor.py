...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Related.anchor'
        db.add_column(u'related_related', 'anchor',
                      self.gf('django.db.models.fields.CharField')(default='23_c_1', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Related.anchor'
        db.delete_column(u'related_related', 'anchor')
