...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'related_related', (
            ...
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['images.Image'], null=True, blank=True)),
            ('image_collection', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['images.ImageCollection'], null=True, blank=True)),
            ('height', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'related', ['Related'])


    def backwards(self, orm):
        # Deleting model 'Related'
        db.delete_table(u'related_related')
