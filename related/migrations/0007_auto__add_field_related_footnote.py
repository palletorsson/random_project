...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Related.footnote'
        db.add_column(u'related_related', 'footnote',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Related.footnote'
        db.delete_column(u'related_related', 'footnote')
    ...
    models = {
        ...
        u'posts.post': {
            ...
            'publish_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 26, 0, 0)'}),
        ...
        u'related.related': {
            ...
            'footnote': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
