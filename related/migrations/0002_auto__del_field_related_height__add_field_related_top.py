...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Related.height'
        db.delete_column(u'related_related', 'height')

        # Adding field 'Related.top'
        db.add_column(u'related_related', 'top',
                      self.gf('django.db.models.fields.IntegerField')(default=124),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Related.height'
        db.add_column(u'related_related', 'height',
                      self.gf('django.db.models.fields.IntegerField')(default=234),
                      keep_default=False)

        # Deleting field 'Related.top'
        db.delete_column(u'related_related', 'top')
    ...
    models = {
        ...
        u'posts.post': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'publish_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 10, 0, 0)'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
